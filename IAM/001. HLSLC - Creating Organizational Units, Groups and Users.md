...
```
New-ADGroup -Name "Accounting" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "Dispatch" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "IT" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "Management" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "Sales" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "Warehouse" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "Warehouse-Seasonal" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "Finance-Data-Access" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
New-ADGroup -Name "Helpdesk" -Path "OU=Group,OU=HLSLC,DC=lab,DC=local"
```
