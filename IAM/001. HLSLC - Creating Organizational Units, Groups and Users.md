...
Groups are created inside the company's OU in the same level as the department's OU, in this nested OU are created the different groups that will be used to assign rights and privilegies to users according to their role in the company.
